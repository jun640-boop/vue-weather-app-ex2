<template>
  <div class="weather-info">
    ...
    <div class="icon">
      <img :src="`https://openweathermap.org/img/wn/${$store.state.weatherData.icon}@2x.png`"
    ...
    <div class="location"> {{$store.state.weatherData.city}},
      {{$store.state.weatherData.location}}</div>
  </div>
</template>
